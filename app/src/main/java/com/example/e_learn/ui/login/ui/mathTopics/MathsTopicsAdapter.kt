...
class MathsTopicsAdapter(context:Context, topics: List<String>) :
    ArrayAdapter<String>(context, android.R.layout.simple_spinner_item,topics) {

    interface onItemSelectedListener{
        fun onItemSelected(maths:String)
    }
